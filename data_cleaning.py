...
data = df[["DisNo.", "Disaster Type", "ISO", "Country", "Subregion", "Region", "Latitude", "Longitude", "Start Year", "Start Month", 
...
data.rename(
    columns = {
        ...
        "Subregion": "subregion", "Region": "region", "Latitude": "latitude", "Longitude": "logitude",
